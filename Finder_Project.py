...
while True:
    ...
    if User_input=="I15":
        URL= "https://www.ideabeam.com/mobile/apple-iphone-15-price.html#gsc.tab=0&gsc.q=Apple%20iPhone%2015&gsc.sort="
        break
    elif User_input=="I14":
...
print(product.strip())
print(title.strip() ,"1)Low_Price =" ,lowPrice,"2)HIGH_Price= ",highPrice)
